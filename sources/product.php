<?php  if(!defined('_source')) die("Error");
...

	{
		...
		$sql_detail = "select id,ten$lang as ten,mota$lang as mota,noidung$lang as noidung,masp,gia,giacu,giangay,soldout,map,luotxem,thumb,photo,size,mausac,id_danhmuc,id_list,id_cat,id_loaitienich,id_loaicanho,title,keywords,description,diachi,sophongngu,dientich,phuong,namtrenduong,quan,giadien,gianuoc,phidichvu,phiguixe,linkvideo,lau,sophong FROM #_product where tenkhongdau='$id' and hienthi=1 limit 0,1";
		...
		$id_danhmuc = $row_detail['id_danhmuc'];	
...

	{
		...
		$sql = "select id,ten$lang as ten,title,keywords,description,id_danhmuc FROM #_product_cat where id='$id_cat' limit 0,1";
	...
	{		
		...
		$sql = "select id,ten$lang as ten,title,keywords,description FROM #_product_danhmuc where id='$id_danhmuc' or tenkhongdau='$id_danhmuc' and type='location' limit 0,1";
...

	{
		...
		if($com=='can-ho-noi-bat')

		{

			if($id_danhmuc!=''){

				$where = " type='".$type."' and id_danhmuc=".$title_bar['id']." and noibat=1 and hienthi=1 order by stt,id desc";

			}else{

				$where = " type='".$type."' and noibat=1 and hienthi=1 order by stt,id desc";
	...
	$sql = "select id,ten$lang as ten,tenkhongdau,thumb,photo,masp,gia,giangay,giacu,dientich,sophongngu,diachi,soldout,id_danhmuc,id_list,id_cat,id_loaicanho,lau,sophong,soldout FROM #_product where $where limit $bg,$pageSize";		
