<?php  if(!defined('_source')) die("Error");
    ...
    if($id!='')
	{
		...
		//Chi tiết tin tức
		$d->reset();
		$sql_detail = "select id,ten$lang as ten,mota$lang as mota,noidung$lang as noidung,id_danhmuc,id_list,id_cat,title,photo,keywords,description,ngaytao,luotxem FROM #_news where hienthi=1 and tenkhongdau='$id' limit 0,1";
		$d->query($sql_detail);
	...
	$d->reset();
	$sql = "select id,ten$lang as ten,tenkhongdau,thumb,photo,mota$lang as mota,ngaytao,file_upload FROM #_news where $where limit $bg,$pageSize";		
	$d->query($sql);
