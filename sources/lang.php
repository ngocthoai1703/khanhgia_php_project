...
@define ('_khacbiet', 'Sự khác biệt');

@define ('_bo', 'BỘ');

@define ('_suutap', 'SƯU TẬP');

@define ('_4khacbiet', '4 KHÁC BIỆT');

@define ('_lamnensutinhte', 'LÀM NÊN SỰ TINH TẾ');

//------------ menutop -----------------
@define ('_SignatureByKG', 'Signature by Khánh Gia Apartment');

@define ('_timphong', 'Tìm phòng');

//------------ noidungbannertimkiem -----------------

@define ('_khampha', 'Khám phá');

@define ('_nhapidphong', 'Nhập id phòng');

//------------ gioithieu.index -----------------

@define ('_khanhgiaapart', 'Khánh Gia Apartment');

//------------ index.tpl -----------------

@define ('_luachonphong', 'Lựa chọn phòng');

@define ('_choban', 'cho bạn');

@define ('_wifitocdocao', 'Wifi tốc độ cao');

@define ('_tvtrongphong', 'TV trong phòng');

@define ('_ghesofa', 'Ghế sofa');

@define ('_viewtp', 'View thành phố');

@define ('_giathue', 'Giá thuê');

//------------ khachhang -----------------

@define ('_cauchuyendancu', 'Câu chuyện dân cư');
...
@define ('_khonggiancua', 'Không gian của');

//------------ hinhthuclienhe -----------------

@define ('_bancangiupdo', 'Bạn cần chúng tôi giúp đỡ');

@define ('_dangkitrainghiem', 'Đăng ký trải nghiệm');
...
@define ('_phuhop', 'phù hợp');

@define ('_nguoio', 'người ở');

@define ('_giuongdon', 'giường đơn');

@define ('_giuongdoi', 'giường đôi');

@define ('_giuongdoi-don', 'giường đôi - đơn');

@define ('_dacokhach', 'Đã có khách');

@define ('_controng', 'Còn trống');

@define ('_mota', 'Mô tả');

@define ('_luachonkhac', 'Các lựa chọn khác');

@define ('_daduocthue', 'Đã được thuê');

@define ('_thuvienanh', 'Thư viện ảnh');

@define ('_trieudem', '/đêm');

//------------ product.tpl -----------------

@define ('_khonggian', 'Không gian');

@define ('_chonphong', 'Chọn phòng');

@define ('_huyphong', 'Hủy phòng');

@define ('_noidunghuyphong', 'MIỄN PHÍ tối đa 3 ngày trước ngày nhận phòng');

@define ('_khongtimthay', 'Không tìm thấy loại phòng quý khách yêu cầu');

//------------ blog -----------------

@define ('_nangtamtrainghiem', 'Nâng tầm trải nghiệm sống');

@define ('_noidungblog', 'Tại Khánh Gia Apartment bạn được thoải mái tận hưởng các tiện ích cao cấp, những trải nghiệm thú vị ngay từ khi bước vào.');
...
@define ('_doitac','Đối tác khách hàng');
...
@define ('_visao_chonchungtoi','Vì sao chọn chúng tôi');
...
@define ('_tatca_duan','Tất cả dự án');

@define ('_duankhac','Các dự án khác');

@define ('_ten_file','Tên file');

@define ('_camnangdl','Cẩm nang du lịch');

@define ('_camnangdlkhac','Cẩm nang du lịch khác');

@define ('_hotro','Hỗ trợ');

@define ('_chinhsach','Chính sách');

@define ('_duan_dathuchien','Dự án đã thực hiện');

@define ('_giadien','Giá điện');
@define ('_gianuoc','Giá nước');
@define ('_phidichvu','Phí dịch vụ');
@define ('_phiguixe','Phí gửi xe');



@define ('_kWh','ngàn/kWh');
@define ('_m3','ngàn/m3');
@define ('_nguoi','ngàn/người');
@define ('_chiec','ngàn/chiếc');


@define ('_linhvuchoatdong','Lĩnh vực hoạt động');

@define ('_sukien_hot','Sự kiện HOT');

@define ('_thanhvien','Thành viên');

@define ('_haygoingaychochungtoi','HÃY GỌI NGAY CHO CHÚNG TÔI');
...
@define ('_thamkhao','Tham khảo');

@define ('_codong','Cổ đông');

@define ('_choncanho','Chọn căn hộ');

//----------------Filter-------------------

@define ('_nhapvitri','Nhập vị trí');

@define ('_chonvitri','Chọn vị trí');
@define ('_chonquan','Chọn quận');
@define ('_chonhuyen','Chọn huyện');
@define ('_chonduong','Chọn đường');
@define ('_lau','Lầu số');
@define ('_phong','Phòng số');


@define ('_phongngu','Phòng ngủ');

@define ('_tatcatienich','Tất cả tiện ích');

@define ('_thapnhat','Thấp nhất');

@define ('_caonhat','Cao nhất');

@define ('_tatcacanho','Tất cả căn hộ');

@define ('_dientich','Diện tích');

@define ('_dangkituvan','Đăng ký tư vấn');

@define ('_sodtcuaban','Số điện thoại của bạn');

@define ('_emailcuaban','Email của bạn');

@define ('_noidungcantuvan','Nội dung cần tư vấn');

@define ('_dangkituvan2','ĐĂNG KÍ');
...
@define ('_sanphamcuachungtoi','Các sản phẩm của chúng tôi');

@define ('_canhonoibat','Căn hộ nổi bật');

@define ('_canhodathue','Căn hộ đã được thuê');

@define ('_khachhangcuachungtoi','Khách hàng của chúng tôi');

@define ('_tatca','Tất cả');

@define ('_trieuthang','/tháng');

@define ('_nganngay','/ngày');
...
@define ('_nhapemailcuaban','Nhập email của bạn để nhận thông tin mới nhất từ website');
...
@define ('_chamsockhachhang','Thông tin khách hàng');

@define ('_dichvugiaohang','Dịch vụ giao hàng');
...
@define ('_loaicanho','Loại căn hộ');

@define ('_hotenres','HỌ VÀ TÊN (BẮT BUỘC)');

@define ('_sdtres','SỐ ĐIỆN THOẠI (BẮT BUỘC)');

@define ('_emailres','EMAIL CỦA BẠN (BẮT BUỘC)');

@define ('_ngaydenres','NGÀY ĐẾN (BẮT BUỘC)');

@define ('_ngaydires','NGÀY ĐI (BẮT BUỘC)');

@define ('_nguoilon','NGƯỜI LỚN');

@define ('_treem','TRẺ EM');

@define ('_phong','LOẠI PHÒNG');

@define ('_camontinnhan','Cảm ơn về tin nhắn của bạn. Nó đã được gửi đi.');
