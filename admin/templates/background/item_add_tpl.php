        ...
        <div id="content_lang_<?=$key?>" class="tab_content">	
            ...
            <div class="formRow" >
                ...
                <div class="formRight">
                    ...
                    <?php if($_REQUEST['type']=='banner') { ?><span class="size_img">Chiều rộng <b>700px</b> Chiều cao: <b>170px</b></span><?php } ?>
                    <?php if($_REQUEST['type']=='logo') { ?><span class="size_img">Chiều rộng <b>160px</b> Chiều cao: <b>160px</b></span><?php } ?>
