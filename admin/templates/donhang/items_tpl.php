...
<form name="f" id="f" method="post">
	...
	<div class="widget">
		...
		<h6>Danh sách đơn đặt phòng</h6>
	</div>
	<table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
		<thead>
			<tr>
				<td></td>
				<td class="sortCol" width="120"><div>Mã đơn đặt phòng<span></span></div></td>     
				<td class="sortCol"><div>Họ tên<span></span></div></td>
				<td class="sortCol" width="150"><div>Ngày đặt<span></span></div></td>
				<td width="150">Tên phòng cần thuê </td>
			...
			<?php for($i=0, $count=count($items); $i<$count; $i++){?>
				<tr>
					...
					<td align="center">
						<?php
						$d->reset();
						$sql_chitietdonhang = "select gia,giacu,soluong,ten from #_chitietdonhang where madonhang='".$items[$i]['madonhang']."' order by stt,id desc";
						$d->query($sql_chitietdonhang);
						$chitietdonhang = $d->fetch_array();
