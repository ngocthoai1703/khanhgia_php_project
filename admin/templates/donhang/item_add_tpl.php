...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	 <li><a href="index.php?com=order&act=mam"><span>Đơn đặt phòng</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=order&act=save" method="post" enctype="multipart/form-data">
	<div class="widget">
        ...
        <div class="formRow">
         ...
         <div class="formRow">
			...
			<div class="formRight">
             <input type="text" name="ngayden" title="Ngày khách đến" style="width:80% !important"  id="ngayden" class="tipS" value="<?=date('d/m/Y',strtotime(@$item['ngayden']));?>" />
			</div>
			<div class="clear"></div>
		</div>	
        <div class="formRow">
			<label>Ngày đi</label>
			<div class="formRight">
             <input type="text" name="ngaydi" title="Ngày khách đi" style="width:80% !important"  id="ngaydi" class="tipS" value="<?=date('d/m/Y',strtotime(@$item['ngaydi']));?>" />
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
			...
			<div class="formRight">
             <input type="text" name="songuoilon" title="Số lượng người lớn" style="width:80% !important"  id="songuoilon" class="tipS" value="<?=@$item['songuoilon']?>" />
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
			...
			<div class="formRight">
             <input type="text" name="sotreem" title="Số lượng trẻ em" style="width:80% !important"  id="sotreem" class="tipS" value="<?=@$item['sotreem']?>" />
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
			...
			<div class="formRight">
             <input type="text" name="sophongngu" title="Số phòng ngủ khách cần" style="width:80% !important"  id="sophongngu" class="tipS" value="<?=@$item['sophongngu']?>" />
			</div>
			<div class="clear"></div>
		</div>
    ...
    <thead>
      <tr>
        ...
        <td class="sortCol"><div>Tên loại phòng<span></span></div></td>
        <td width="150">Hình ảnh</td>
       
        <td width="100">Giá thuê</td>
    ...
    <tbody>
        ...
        <tr id="productct<?=$chitietdonhang[$i]['id']?>">
          ...
          <td align="center">
		  	<?=number_format($chitietdonhang[$i]['gia'],0, ',', '.').'&nbsp;triệu/tháng';?>
		  </td>
          <td align="center">
		  	<?=$chitietdonhang[$i]['diachi'];?>
		  </td>
