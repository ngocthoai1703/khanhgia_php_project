       ...
       <div id="info" class="tab_content">
		...
		<div class="formRow">
			...
			<div class="formRight">
                ...
                <div class="note">  
				<?php if($_REQUEST['type']=='slider')echo 'Width:1366px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Height:570px '; ?>
                 
                <?php if($_REQUEST['type']=='slider2')echo 'Width:510px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Height:480px '; ?> 
                
                <?php if($_REQUEST['type']=='slide_index')echo 'Width:1366px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Height:260px '; ?> 
                
                <?php if($_REQUEST['type']=='hiephoi' || $_REQUEST['type']=='doitac')echo 'Width:200px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Height:120px '; ?>
