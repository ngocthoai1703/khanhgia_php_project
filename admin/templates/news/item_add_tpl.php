...
<form name="supplier" id="validate" class="form" action="index.php?com=news&act=save&p=<?=$_REQUEST['p']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
       ...
       <div id="info" class="tab_content">
        ...
        <div class="formRow">
			...
			<div class="formRight">
                ...
                <div class="note"> Width:265px | Height:410px<?=_format_duoihinh_l?> </div>
                <?php } else { ?>
                <div class="note"> Width:200px | Height:150px<?=_format_duoihinh_l?> </div>
                <?php } ?>
    ...
    <?php }?>
 	...
 	<div class="formRow">
        ...
        <?php if($_GET['type']=='tintuc' || $_GET['type']=='congtrinh') { ?>
        <div class="formRow">
