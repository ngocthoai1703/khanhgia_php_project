...
<form name="supplier" id="validate" class="form" action="index.php?com=product&act=save_danhmuc<?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
       ...
       <div id="info" class="tab_content">
        ...
        <div class="formRow">
			...
			<div class="formRight">
				...
				<div class="note"> Height:220px | Width:220px  <?=_format_duoihinh_l?> </div>
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow">
			...
			<div class="mt10"><img src="<?=_upload_sanpham.$item['photo']?>" alt="NO PHOTO" style="height:150px" /></div>
 	...
 	<div class="formRow">
        ...
        <div class="formRow">
            <label>Liên hệ:</label>
            <div class="formRight">
                <textarea rows="8" cols="" title="Nội dung thẻ liên hệ" class="tipS description_input" name="description"><?=@$item['description']?></textarea>
