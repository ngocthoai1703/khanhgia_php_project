...
<iframe title="<?=$video[0]['ten']?>" width="100%" height="280px" src="http://www.youtube.com/embed/<?=getYoutubeIdFromUrl($video[0]['link'])?>" frameborder="0" allowfullscreen></iframe>
</div>
...
<style type="text/css">
.left_video {width:calc(100% - 130px);float: left;}
.select_video {width:120px;float: right;}
.select_video img {width:100%;cursor:pointer;margin-bottom: 5px;}
